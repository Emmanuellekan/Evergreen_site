    ...
    p.extend({
        appear: function(e, r) {
            ...
            if (!o) {
                var i = function() {
                    f || (f = !0,
                    setTimeout(d, a.interval))
                };
                p(window).scroll(i).resize(i),
                o = !0
            }
...
(function(a) {
    ...
    a.instagramFeed = function(f) {
        function g(d) {
            if ("string" == typeof d) {
                ...
                if ("undefined" == typeof d) {
                    ...
                    if (null !== g && (d = JSON.parse(g),
                    f = !0),
                    h.on_error("Instagram Feed: Your network has been temporary banned by Instagram because of too many requests. Consider increasing your 'cache_time'. See https://github.com/jsanahuja/jquery.instagramFeed/issues/25 and https://github.com/jsanahuja/jquery.instagramFeed/issues/101", 4),
                    !d)
                        return
                }
                !f && 0 < h.cache_time && (localStorage.setItem(m, JSON.stringify(d)),
                localStorage.setItem(n, new Date().getTime()))
            }
            if (d = d[0].graphql.user || d[0].graphql.hashtag,
            "" != h.container) {
                var k, l = "";
                if (h.styling) {
                ...
                h.display_profile && (l += "<div class=\"instagram_profile\"" + k.profile_container + ">",
                ...
                l += j ? "<p class=\"instagram_tag\"" + k.profile_name + "><a href=\"https://www.instagram.com/explore/tags/" + h.tag + "\" rel=\"noopener\" target=\"_blank\">#" + h.tag + "</a></p>" : "<p class='instagram_username'" + k.profile_name + ">@" + d.full_name + " (<a href='https://www.instagram.com/" + h.username + "' rel='noopener' target='_blank'>@" + h.username + "</a>)</p>",
                !j && h.display_biography && (l += "<p class='instagram_biography'" + k.profile_biography + ">" + d.biography + "</p>"),
                l += "</div>");
                ...
                if (h.display_gallery)
                    if ("undefined" != typeof d.is_private && !0 === d.is_private)
                        ...
                        for (var r = 0; r < x; r++) {
                            var s, t, u = "https://www.instagram.com/p/" + q[r].node.shortcode, v = b(c(q[r], d));
                            switch (q[r].node.__typename) {
                            case "GraphSidecar":
                                t = "sidecar",
                                s = q[r].node.thumbnail_resources[p].src;
                                break;
                            case "GraphVideo":
                                t = "video",
                                s = q[r].node.thumbnail_src;
                                break;
                            default:
                                t = "image",
                                s = q[r].node.thumbnail_resources[p].src;
        ...
        if ("" == h.username && "" == h.tag)
            return h.on_error("Instagram Feed: Error, no username nor tag defined.", 1),
            !1;
        if ("undefined" != typeof h.get_data && console.warn("Instagram Feed: options.get_data is deprecated, options.callback is always called if defined"),
        null == h.callback && "" == h.container)
            return h.on_error("Instagram Feed: Error, neither container found nor callback defined.", 2),
            !1;
        var j = "" == h.username
